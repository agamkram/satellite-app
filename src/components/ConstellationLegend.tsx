    ...
    <>
      ...
      {open ? (
        <div
          ...
          className="pointer-events-auto max-h-[min(50dvh,320px)] w-[min(240px,calc(100vw-1.5rem))] overflow-y-auto rounded-xl border border-white/10 bg-black/55 p-2 backdrop-blur-md desktop:max-h-[min(32dvh,200px)]"
        >
